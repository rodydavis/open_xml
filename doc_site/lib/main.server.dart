        ...
        DocsLayout(
          header: Header(
            ...
            items: [
              ...
              ThemeToggle(),
              // Shows github stats.
              GitHubButton(repo: 'rodydavis/open_xml'),
            ],
          ),
          sidebar: Sidebar(
            groups: [
              ...
              SidebarGroup(
                ...
                links: [
                  ...
                  SidebarLink(text: "Core Concepts", href: '/core'),
                ],
              ),
              SidebarGroup(
                title: 'Document Formats',
                links: [
                  SidebarLink(text: "Word (.docx)", href: '/docx'),
                  SidebarLink(text: "Spreadsheets (.xlsx)", href: '/xlsx'),
                  SidebarLink(text: "Presentations (.pptx)", href: '/pptx'),
                ],
              ),
            ],
          ),
